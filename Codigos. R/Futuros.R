...
# Simulación
cantidad_gasolina <- 10000  # Cantidad de gasolina a cubrir (en litros)
...
# Visualizar resultados con ggplot
ggplot(datos_dif, aes(x = Fecha)) +
  ...
  scale_color_manual(values = c("Sin Cobertura" = "red", "Con Cobertura" = "blue")) +
  theme_minimal()
